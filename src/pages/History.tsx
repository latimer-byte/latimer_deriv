    ...
    <div className="space-y-8 pb-20 aegis-grid min-h-screen">
      ...
      <div className="glass-card overflow-hidden bg-brand-forest/40 border-orange-900/20">
        <div className="p-4 border-b border-orange-900/20 flex flex-col md:flex-row gap-4 items-center justify-between bg-brand-earth/50">
          ...
          <div className="flex gap-2 w-full md:w-auto">
            ...
            <select 
              ...
              className="flex-1 md:flex-none px-4 py-2 bg-brand-earth/40 border border-orange-900/20 rounded-xl text-xs font-bold uppercase tracking-widest text-orange-100/40 outline-none focus:ring-2 focus:ring-brand-amber/20 appearance-none"
            >
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-brand-earth/50">
                ...
                <th className="px-6 py-4 text-[10px] font-bold text-orange-100/40 uppercase tracking-widest">Amount</th>
                <th className="px-6 py-4 text-[10px] font-bold text-orange-100/40 uppercase tracking-widest">Status</th>
                <th className="px-6 py-4 text-[10px] font-bold text-orange-100/40 uppercase tracking-widest">Reference</th>
              ...
              {filteredTrades.length > 0 ? filteredTrades.map((trade, i) => (
                ...
                >
                  <td className="px-6 py-4">
                    <p className="font-bold text-white text-sm tracking-tight">{trade.pair}</p>
                  ...
                  <td className="px-6 py-4 font-mono text-[10px] text-orange-100/40">{trade.price}</td>
                  <td className="px-6 py-4 text-[10px] text-orange-100/40 font-bold uppercase tracking-widest">
                ...
                <tr>
                  <td colSpan={7} className="px-6 py-20 text-center">
                    <HistoryIcon className="w-12 h-12 text-orange-100/10 mx-auto mb-4" />
                    <p className="text-orange-100/40 font-bold uppercase tracking-widest text-xs">No neural logs found in this sector</p>
                  </td>
                </tr>
              )}
            </tbody>
        ...
        <div className="p-4 bg-brand-earth/50 border-t border-orange-900/20 flex items-center justify-between">
          <p className="text-[10px] font-bold text-orange-100/20 uppercase tracking-widest">
